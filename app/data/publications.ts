...
export const publications: PublicationEntry[] = [
  {
    ...
    venueHtml: 'Under Review at <strong>EACL 2027 Conference</strong> <span style="font-size:0.85em;">(recommended for Findings in ARR May 2026 cycle)</span>',
  ...
  },
  {
    ...
    venueHtml: 'Under Review at <strong>EACL 2027 Conference</strong>',
    link: 'https://2027.eacl.org/',
